...
public class FMODEvents : SerializedMonoBehaviour
{
    ...
    public Dictionary<string, EventReference> soundEvents = new Dictionary<string, EventReference>(); // reference this when calling for a sound FMODEvents.soundEvents["name of sound"]

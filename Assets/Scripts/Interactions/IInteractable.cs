...
{
    void OnHoverEnter(); // visual or audio feedback when player looks at interactable
    
    void OnHoverExit(); // visual or audio feedback when player looks at interactable

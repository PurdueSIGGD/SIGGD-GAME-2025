// Base pass for Custom/NoFogTerrainLit (fog disabled).
Shader "Hidden/Custom/NoFogTerrainLit (Base Pass)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        // ------------------------------------------------------------------
        //  Forward pass. Shades all light in a single pass. GI + emission (no fog)
        Pass
        {
            Name "ForwardLit"
        ...
        // ------------------------------------------------------------------
        //  GBuffer pass. Does GI + emission. All additional lights are done deferred
        Pass
        {
            Name "GBuffer"
        ...
        UsePass "Custom/NoFogTerrainLit/SceneSelectionPass"
    }
